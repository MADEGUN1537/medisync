...
import { getFirestore, collection, addDoc, doc, setDoc, serverTimestamp, query, where, onSnapshot, deleteDoc, getDoc, limit } from 'https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js';// Firebase Configuration
...
export { auth, db, getFirestore, collection, query, where, onSnapshot, addDoc, doc, setDoc, serverTimestamp, deleteDoc, getDoc, updatePassword, limit };